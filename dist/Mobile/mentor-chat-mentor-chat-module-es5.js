(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["mentor-chat-mentor-chat-module"], {
  ...
  function srcAppPagesMentorsMentorChatMentorChatRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    const routes = [{
      ...
      [__webpack_require__.e("default~chat-page-chat-page-module~fair-page-fair-page-module~modals-replies-page-replies-page-modul~cd85bf8f"), __webpack_require__.e("common"), __webpack_require__.e("chat-page-chat-page-module")]).then(__webpack_require__.bind(null,
      /*! ./chat-page/chat-page.module */
      "./src/app/pages/mentors/mentor-chat/chat-page/chat-page.module.ts")).then(m => m.ChatPagePageModule)
    }];
    let MentorChatPageRoutingModule = class MentorChatPageRoutingModule {};
    MentorChatPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppPagesMentorsMentorChatMentorChatModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    MentorChatPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppPagesMentorsMentorChatMentorChatPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let MentorChatPage = class MentorChatPage {
      ...
      ngOnInit() {// this.mentorChat.createChatRoom();
      }
    ...
    MentorChatPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"], src_app_services_mentor_chat_service__WEBPACK_IMPORTED_MODULE_5__["MentorChatService"]])], MentorChatPage);
    /***/
  },
  ...
  function srcAppServicesMentorChatServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let MentorChatService = class MentorChatService {
      constructor() {
        this.mentorsChat = new SocketNameSpace({
          url: 'http://127.0.0.1:3000/mentor-chat',
          options: {}
        });
      }

      newChatroom() {
        this.mentorsChat.emit('addChatroom', {
          chatId: this.chatId()
        });
      }
    ...
    MentorChatService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], MentorChatService);
    /***/
  }
}]);
