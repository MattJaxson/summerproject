    ...
    var ChatPagePage = /*#__PURE__*/function () {
      ...
      _createClass(ChatPagePage, [{
        ...
        value: function ngOnInit() {
          ...
          this._chatroomSub = this.studentChatService.currentChatRoom.subscribe(function (data) {
            // console.log(data);
            _this.chatroom = data['messages'];
            _this.requestingUserFullname = data['requestingUserFullname'];
            _this.requestingUserEmail = data['requestingUserEmail'];
            _this.requestingUserPhoto = data['requestingUserPhoto'];
            _this.respondingUserFullname = data['respondingUserFullname'];
            _this.respondingUserEmail = data['respondingUserEmail'];
            _this.respondingUserPhoto = data['respondingUserPhoto']; // if (this.chatroom.length >= 5) {
            //   console.log('more than 3 messages sent');
            //   this.studentChatService.deleteMessages(this.chatId, this.fullName , this.email);
            // }

            var _iterator = _createForOfIteratorHelper(_this.chatroom),
                _step;
        ...
        value: function ngAfterViewInit() {
          ...
          setTimeout(function () {
            _this2.input.getInputElement().then(function (input) {
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 7:
                    _context4.next = 9;
                    return this.studentChatService.sendMessage(this.chatId, this.message.value, this.fullName, this.profilePicture, this.requestingUserFullname, this.requestingUserEmail, this.requestingUserPhoto, this.respondingUserFullname, this.respondingUserEmail, this.respondingUserPhoto);
