(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    const routes = [{
      ...
      "./src/app/pages/landing/landing.module.ts")).then(m => m.LandingPageModule) // loadChildren: () => import('./pages/resources/resources.module').then( m => m.ResourcesPageModule)
    ...
    }, //  change to forgot password path name later
    {
      ...
      [__webpack_require__.e("default~chat-page-chat-page-module~fair-page-fair-page-module~modals-replies-page-replies-page-modul~cd85bf8f"), __webpack_require__.e("pages-events-events-module")]).then(__webpack_require__.bind(null,
      ...
      [__webpack_require__.e("default~chat-page-chat-page-module~fair-page-fair-page-module~modals-replies-page-replies-page-modul~cd85bf8f"), __webpack_require__.e("default~modals-replies-page-replies-page-module~post-page-post-page-module"), __webpack_require__.e("common")]).then(__webpack_require__.bind(null,
      /*! ./modals/replies-page/replies-page.module */
      "./src/app/modals/replies-page/replies-page.module.ts")).then(m => m.RepliesPagePageModule)
    }, {
      path: 'edit-post',
      loadChildren: () => __webpack_require__.e(
      ...
      "./src/app/modals/edit-post/edit-post.module.ts")).then(m => m.EditPostPageModule)
    }, {
      path: 'image-cropper',
      loadChildren: () => Promise.all(
      /*! import() | modals-image-cropper-image-cropper-module */
      [__webpack_require__.e("default~change-profile-picture-change-profile-picture-change-profile-picture-module~fair-page-fair-p~ca92f864"), __webpack_require__.e("modals-image-cropper-image-cropper-module")]).then(__webpack_require__.bind(null,
      /*! ./modals/image-cropper/image-cropper.module */
      "./src/app/modals/image-cropper/image-cropper.module.ts")).then(m => m.ImageCropperPageModule)
    }, {
      path: 'third-person-profile',
      loadChildren: () => Promise.all(
      /*! import() | modals-third-person-profile-third-person-profile-module */
      [__webpack_require__.e("default~chat-page-chat-page-module~fair-page-fair-page-module~modals-replies-page-replies-page-modul~cd85bf8f"), __webpack_require__.e("default~modals-third-person-profile-third-person-profile-module~pages-posts-posts-module")]).then(__webpack_require__.bind(null,
      /*! ./modals/third-person-profile/third-person-profile.module */
      "./src/app/modals/third-person-profile/third-person-profile.module.ts")).then(m => m.ThirdPersonProfilePageModule)
    }, {
      path: 'resources',
      loadChildren: () => __webpack_require__.e(
      /*! import() | pages-resources-resources-module */
      "pages-resources-resources-module").then(__webpack_require__.bind(null,
      /*! ./pages/resources/resources.module */
      "./src/app/pages/resources/resources.module.ts")).then(m => m.ResourcesPageModule)
    }, {
      path: 'report-convo',
      loadChildren: () => __webpack_require__.e(
      ...
      "./src/app/modals/report-convo/report-convo.module.ts")).then(m => m.ReportConvoPageModule)
    }, {
      ...
      "./src/app/modals/new-message-student/new-message-student.module.ts")).then(m => m.NewMessageStudentPageModule)
    }, {
      ...
      "./src/app/modals/new-message-mentor/new-message-mentor.module.ts")).then(m => m.NewMessageMentorPageModule)
    }, {
      ...
      "./src/app/modals/report-convo-mentor/report-convo-mentor.module.ts")).then(m => m.ReportConvoMentorPageModule)
    }, {
      path: 'selection',
      loadChildren: () => Promise.all(
      /*! import() | pages-fairs-selection-selection-module */
      [__webpack_require__.e("common"), __webpack_require__.e("pages-fairs-selection-selection-module")]).then(__webpack_require__.bind(null,
      /*! ./pages/fairs/selection/selection.module */
      "./src/app/pages/fairs/selection/selection.module.ts")).then(m => m.SelectionPageModule)
    }, {
      path: 'fair-student-register',
      loadChildren: () => Promise.all(
      /*! import() | modals-fair-student-register-fair-student-register-module */
      ...
      /*! ./modals/fair-student-register/fair-student-register.module */
      "./src/app/modals/fair-student-register/fair-student-register.module.ts")).then(m => m.FairStudentRegisterPageModule)
    }, {
      path: 'fair-chaperone-register',
      loadChildren: () => Promise.all(
      /*! import() | modals-fair-chaperone-register-fair-chaperone-register-module */
      [__webpack_require__.e("default~fair-page-fair-page-module~modals-fair-chaperone-register-fair-chaperone-register-module~pag~111c3137"), __webpack_require__.e("common")]).then(__webpack_require__.bind(null,
      /*! ./modals/fair-chaperone-register/fair-chaperone-register.module */
      "./src/app/modals/fair-chaperone-register/fair-chaperone-register.module.ts")).then(m => m.FairChaperoneRegisterPageModule)
    }, {
      path: 'fair-partner-register',
      loadChildren: () => Promise.all(
      /*! import() | modals-fair-partner-register-fair-partner-register-module */
      [__webpack_require__.e("default~change-profile-picture-change-profile-picture-change-profile-picture-module~fair-page-fair-p~ca92f864"), __webpack_require__.e("default~fair-page-fair-page-module~modals-fair-partner-register-fair-partner-register-module~pages-f~4a4bc971"), __webpack_require__.e("common")]).then(__webpack_require__.bind(null,
      /*! ./modals/fair-partner-register/fair-partner-register.module */
      "./src/app/modals/fair-partner-register/fair-partner-register.module.ts")).then(m => m.FairPartnerRegisterPageModule)
    }, {
      path: 'fair-volunteer-register',
      loadChildren: () => __webpack_require__.e(
      /*! import() | modals-fair-volunteer-register-fair-volunteer-register-module */
      "default~fair-page-fair-page-module~modals-fair-volunteer-register-fair-volunteer-register-module~pag~3448d0f3").then(__webpack_require__.bind(null,
      /*! ./modals/fair-volunteer-register/fair-volunteer-register.module */
      "./src/app/modals/fair-volunteer-register/fair-volunteer-register.module.ts")).then(m => m.FairVolunteerRegisterPageModule)
    }, {
      path: 'fair-page/:id/:fair/:date/:address/:city/:state/:zip/:usertype/:summary/:agenda/:faq/:partners',
      loadChildren: () => Promise.all(
      /*! import() | pages-fairs-selection-fair-page-fair-page-module */
      [__webpack_require__.e("default~chat-page-chat-page-module~fair-page-fair-page-module~modals-replies-page-replies-page-modul~cd85bf8f"), __webpack_require__.e("default~change-profile-picture-change-profile-picture-change-profile-picture-module~fair-page-fair-p~ca92f864"), __webpack_require__.e("default~fair-page-fair-page-module~modals-fair-chaperone-register-fair-chaperone-register-module~pag~111c3137"), __webpack_require__.e("default~fair-page-fair-page-module~modals-fair-student-register-fair-student-register-module~pages-f~b8c2ad4d"), __webpack_require__.e("default~fair-page-fair-page-module~modals-fair-partner-register-fair-partner-register-module~pages-f~4a4bc971"), __webpack_require__.e("default~fair-page-fair-page-module~modals-fair-volunteer-register-fair-volunteer-register-module~pag~3448d0f3"), __webpack_require__.e("default~fair-page-fair-page-module~pages-fairs-selection-fair-page-fair-page-module"), __webpack_require__.e("common")]).then(__webpack_require__.bind(null,
      /*! ./pages/fairs/selection/fair-page/fair-page.module */
      ...
      "./src/app/modals/upload-resume-modal/upload-resume-modal.module.ts")).then(m => m.UploadResumeModalPageModule)
    }];
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AppComponent = class AppComponent {
      ...
      initializeApp() {
        ...
        this.platform.ready().then(() => {}); // State for the User. If Authentication State == False, the app reverts back to the landing page

        this.auth.authenticationState.subscribe(state => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          if (state) {
  ...
  function srcAppComponentsCommentVoteBarCommentVoteBarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let CommentVoteBarComponent = class CommentVoteBarComponent {
      ...
      upVoteComment() {
        this.posts.upVoteComment(this.postID, this.commentID, this.userEmail).subscribe(data => {
      ...
      downVoteComment() {
        this.posts.downVoteComment(this.postID, this.commentID, this.userEmail).subscribe(data => {
          const upvotes = data['upvotes'];
          const downvotes = data['downvotes'];
          console.log(data);
          this.upVoteCount$.next(upvotes);
  ...
  function srcAppComponentsGoingIconGoingIconComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "p {\n  -webkit-transition: 0.5s;\n  transition: 0.5s;\n  opacity: 1;\n}\n\nion-button {\n  font-size: 1em;\n  font-weight: 800;\n  height: 40px;\n  width: 100px;\n  margin-left: 0px;\n  margin-right: 10px;\n}\n\n.not-going {\n  --color: white;\n  --background: linear-gradient(#faa71b, #e99b14);\n}\n\n.grey-button {\n  margin-right: 10px;\n  --background: #edf3f8;\n  color: #005191;\n}\n\n.going {\n  --color: white;\n  --background: #24d8a8;\n  --background-hover: #24d8a8;\n}\n\n.going:hover {\n  --color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppServicesFavoritesServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let FavoritesService = class FavoritesService {
      ...
      favoriteThisJob(job) {
        ...
        job.userEmail = email;
        let id = job._id; // this.favoriteJobs$.next([job]);
      ...
      unFavoriteThisJob(job) {
        ...
        job.userEmail = email;
        let id = job._id; // post to database
        ...
        this.http.post("".concat(this.BACKEND_URL, "/api/jobs/unfavorite"), {
          ...
          let updatedFavorites = [...Object.values(data)]; // for (let i = 0; i < updatedFavorites.length; i++) {
  ...
  function srcAppServicesProfileServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let ProfileService = class ProfileService {
      constructor(http, storage, alertController, helper, auth, router, toastController) {
        ...
        this.about = new rxjs__WEBPACK_IMPORTED_MODULE_8__["BehaviorSubject"]('');
      ...
      changeAbout(email, newAbout, passsword) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          return yield this.http.post("".concat(this.BACKEND_URL, "/api/home/user/change-about"), {
            email,
            newAbout,
            passsword
          }).subscribe();
      ...
      changeProfilePicture(imageForm, oldPhotoKey) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          return this.http.post("".concat(this.BACKEND_URL, "/api/photo/change-profile-picture"), {
            imageForm,
            oldPhotoKey
          }).subscribe();
        });
