...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | chat-page-chat-page-module */[__webpack_require__.e("default~chat-page-chat-page-module~fair-page-fair-page-module~modals-replies-page-replies-page-modul~cd85bf8f"), __webpack_require__.e("common"), __webpack_require__.e("chat-page-chat-page-module")]).then(__webpack_require__.bind(null, /*! ./chat-page/chat-page.module */ "./src/app/pages/posts/student-chat/chat-page/chat-page.module.ts")).then(m => m.ChatPagePageModule)
    },
];
