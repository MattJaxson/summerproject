...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modals-third-person-profile-third-person-profile-module~pages-posts-posts-module"], {
  ...
  function srcAppModalsThirdPersonProfileThirdPersonProfilePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(ThirdPersonProfilePage, [{
        ...
        value: function theirPosts(email) {
          ...
          this.profile.getTheirDetails(email).subscribe(function (details) {
            ...
            _this.dob = Object(date_fns__WEBPACK_IMPORTED_MODULE_3__["format"])(new Date(details['dob']), 'MMMM do, yyyy');
    ...
    ThirdPersonProfilePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
