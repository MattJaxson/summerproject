    ...
    let RepliesPagePage = class RepliesPagePage {
      ...
      reply(reply) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          yield this.posts.replyComment(this.commentID, this.postID, reply.reply, this.userFullName, this.userEmail, this.commentUserProfilePicture, this.commentUserFullName, this.commentUserEmail).subscribe(data => {
            let currentComment;
            ...
            let replies = data['replies']; // Give User ability to Edit, Delete, or Report a Comment.
      ...
      repliesLoading() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          const {
            role,
            data
          } = yield loading.onDidDismiss(); // await this.modal.dismiss();
