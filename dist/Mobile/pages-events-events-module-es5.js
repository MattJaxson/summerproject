    ...
    let EventsPage = class EventsPage {
      ...
      ngOnInit() {
        ...
        this.eventsGoing = this.events.getEvents().subscribe(events => {
          ...
          this.allEvents.reverse(); // Second Array of Events

          this.loadedAllEvents = Object.values(events);
          this.loadedAllEvents.reverse(); // Loop each Event and format the dates. Also, delete an Event if its scheduled date
