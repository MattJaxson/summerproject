...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/auth/forgot-password/new-password/new-password.page.html":
/*!**********************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/auth/forgot-password/new-password/new-password.page.html ***!
  \**********************************************************************************************************/
...
var routes = [
    ...
    {
        path: 'confirm',
        loadChildren: function () { return __webpack_require__.e(/*! import() | confirm-confirm-module */ "confirm-confirm-module").then(__webpack_require__.bind(null, /*! ../confirm/confirm.module */ "./src/app/pages/auth/forgot-password/confirm/confirm.module.ts")).then(function (m) { return m.ConfirmPageModule; }); }
    }
];
...
var NewPasswordPage = /** @class */ (function () {
    ...
    NewPasswordPage.prototype.formOnChanges = function () {
        var _this = this;
        ...
        this.newPasswordForm.valueChanges
            ...
            if (_this.newPasswordForm.controls.newPassword.value === _this.newPasswordForm.controls.reTypePassword.value &&
                _this.newPasswordForm.controls.newPassword.touched) {
    ...
    NewPasswordPage.prototype.goToConfirmPage = function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (newPassword !== reTypeNewPassword) {
                            this.presentToast();
                            return [2 /*return*/, console.log('passwords do not match')];
                        }
                        return [4 /*yield*/, this.auth.forgotPassword(email, newPassword)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, console.log('Going to Confirm Password Change Page')];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.router.navigate(['/enter-email/enter-code/:email/new-password/:email/confirm'])];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    NewPasswordPage.prototype.presentToast = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    NewPasswordPage.prototype.cancel = function () {
    ...
    NewPasswordPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./new-password.page.html */ "./node_modules/raw-loader/index.js!./src/app/pages/auth/forgot-password/new-password/new-password.page.html"),
            styles: [__webpack_require__(/*! ./new-password.page.scss */ "./src/app/pages/auth/forgot-password/new-password/new-password.page.scss")]
        }),
