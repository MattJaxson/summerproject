...
var ConfirmPhotoPageRoutingModule = /** @class */ (function () {
    function ConfirmPhotoPageRoutingModule() {
    }
...
var ConfirmPhotoPageModule = /** @class */ (function () {
    function ConfirmPhotoPageModule() {
    }
...
var ConfirmPhotoPage = /** @class */ (function () {
    function ConfirmPhotoPage(router) {
        this.router = router;
    }
    ConfirmPhotoPage.prototype.ngOnInit = function () {
    };
    ConfirmPhotoPage.prototype.uploadPhoto = function () {
    ...
    ConfirmPhotoPage.prototype.takeAnotherPhoto = function () {
        //  Access Gallery
        //  Replace last photo taken with another photo
        console.error("TODO: takeAnotherPhoto() not implemented yet");
    };
    ConfirmPhotoPage.prototype.cancel = function () {
        console.log('change photo cancelled');
        this.router.navigate(['/home/profile']);
    };
    ConfirmPhotoPage.ctorParameters = function () { return [
