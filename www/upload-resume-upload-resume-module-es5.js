...
var routes = [
    ...
    },
    {
        ...
        loadChildren: function () { return __webpack_require__.e(/*! import() | login-credentials-login-credentials-module */ "login-credentials-login-credentials-module").then(__webpack_require__.bind(null, /*! ../login-credentials/login-credentials.module */ "./src/app/pages/auth/sign-up/login-credentials/login-credentials.module.ts")).then(function (m) { return m.LoginCredentialsPageModule; }); }
    },
];
var UploadResumePageRoutingModule = /** @class */ (function () {
    function UploadResumePageRoutingModule() {
    }
...
var UploadResumePageModule = /** @class */ (function () {
    function UploadResumePageModule() {
    }
...
var UploadResumePage = /** @class */ (function () {
    ...
    UploadResumePage.prototype.ngOnInit = function () {
    };
    UploadResumePage.prototype.getFormData = function (event) {
        var _this = this;
    ...
    UploadResumePage.prototype.uploadResume = function () {
        var _this = this;
        this.resume.resumeUpload(this.formData).subscribe(function (data) {
            console.log(data['objectUrl']);
            _this.goToCredentialsPage(data['objectUrl']);
        });
    };
    UploadResumePage.prototype.goToCredentialsPage = function (resume) {
    ...
    UploadResumePage.prototype.getFileFromPhone = function () {
        console.error("TODO: getFileFromPhone() not implemented yet");
    };
    UploadResumePage.prototype.cancel = function () {
        console.log('Sign up cancelled');
        this.router.navigate(['']);
    };
    UploadResumePage.prototype.skip = function () {
        console.log('Skipping to Upload Resume >>');
        this.presentAlert();
    };
    UploadResumePage.prototype.presentAlert = function () {
                                                    ...
                                                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                                        switch (_a.label) {
                                                            ...
                                                            case 1:
                                                                ...
                                                                return [4 /*yield*/, this.resume.resumeUpload(canvasData).subscribe(function (data) {
                                                                        console.log(data);
                                                                        console.log('Default Image Upload API Successful');
                                                                        return _this.goToCredentialsPage(data['objectUrl']);
                                                                    })];
                                                            case 2:
                                                                _a.sent();
                                                                return [2 /*return*/];
    ...
    UploadResumePage.ctorParameters = function () { return [
