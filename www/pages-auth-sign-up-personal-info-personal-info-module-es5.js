...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-auth-sign-up-personal-info-personal-info-module"], {
  ...
  function srcAppPagesAuthSignUpPersonalInfoPersonalInfoRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("common"), __webpack_require__.e("profile-picture-profile-picture-module")]).then(__webpack_require__.bind(null,
        /*! ../profile-picture/profile-picture.module */
        "./src/app/pages/auth/sign-up/profile-picture/profile-picture.module.ts")).then(function (m) {
  ...
  function srcAppPagesAuthSignUpPersonalInfoPersonalInfoPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "h6 {\n  padding: unset;\n}\n\n.cancel-button {\n  margin: 25px 0 50px 0;\n}\n\n.orange-button {\n  margin: 40px 0;\n  width: 200px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    var PersonalInfoPage = /*#__PURE__*/function () {
      ...
      _createClass(PersonalInfoPage, [{
        ...
        value: function formOnChanges() {
          ...
          this.userInfoForm.statusChanges.subscribe(function (status) {
            if (status === 'VALID') {
              console.log('you did it bruh');
            }

            console.log(_this2.userInfoForm);
          });
          this.userInfoForm.controls.fullName.statusChanges.subscribe(function (data) {
            console.log(data);
          });
          this.userInfoForm.controls.addressOne.statusChanges.subscribe(function (data) {
            console.log(data);
          });
          this.userInfoForm.controls.addressTwo.statusChanges.subscribe(function (data) {
            console.log(data);
          });
          this.userInfoForm.controls.phone.statusChanges.subscribe(function (data) {
            console.log(data);
          });
          this.userInfoForm.controls.city.statusChanges.subscribe(function (data) {
            console.log(data);
          });
          this.userInfoForm.controls.state.statusChanges.subscribe(function (data) {
            console.log(data);
          });
          this.userInfoForm.controls.zip.statusChanges.subscribe(function (data) {
            console.log(data);
          });
          this.userInfoForm.controls.gender.statusChanges.subscribe(function (data) {
            console.log(data);
          });
          this.userInfoForm.controls.dob.statusChanges.subscribe(function (data) {
            console.log(data);
          });
          this.userInfoForm.controls.school.statusChanges.subscribe(function (data) {
            console.log(data);
          });
          this.userInfoForm.controls.grade.statusChanges.subscribe(function (data) {
            console.log(data);
          });
        }
      }]);
