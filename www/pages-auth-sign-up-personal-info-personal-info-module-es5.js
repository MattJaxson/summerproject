...
var routes = [
    ...
    },
    {
        ...
        loadChildren: function () { return Promise.all(/*! import() | profile-picture-profile-picture-module */[__webpack_require__.e("common"), __webpack_require__.e("profile-picture-profile-picture-module")]).then(__webpack_require__.bind(null, /*! ../profile-picture/profile-picture.module */ "./src/app/pages/auth/sign-up/profile-picture/profile-picture.module.ts")).then(function (m) { return m.ProfilePicturePageModule; }); }
    }
];
var PersonalInfoPageRoutingModule = /** @class */ (function () {
    function PersonalInfoPageRoutingModule() {
    }
...
var PersonalInfoPage = /** @class */ (function () {
    ...
    PersonalInfoPage.prototype.ngOnInit = function () {
    ...
    PersonalInfoPage.prototype.goToProfilePicturePage = function (data) {
        console.log(data);
        this.auth.getPersonalInfo(data);
        this.router.navigate(['/personal-info/profile-picture']);
    };
    PersonalInfoPage.prototype.cancel = function () {
        console.log('Sign up cancelled');
        this.router.navigate(['']);
    };
    PersonalInfoPage.prototype.formOnChanges = function () {
        var _this = this;
    ...
    PersonalInfoPage.ctorParameters = function () { return [
