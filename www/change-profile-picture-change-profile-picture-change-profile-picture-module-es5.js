...
var routes = [
    ...
    {
        path: 'confirm',
        loadChildren: function () { return __webpack_require__.e(/*! import() | confirm-confirm-module */ "confirm-confirm-module").then(__webpack_require__.bind(null, /*! ../confirm/confirm.module */ "./src/app/pages/profile/change-profile-picture/confirm/confirm.module.ts")).then(function (m) { return m.ConfirmPageModule; }); }
    }
];
var ChangeProfilePicturePageRoutingModule = /** @class */ (function () {
    function ChangeProfilePicturePageRoutingModule() {
    }
...
var ChangeProfilePicturePageModule = /** @class */ (function () {
    function ChangeProfilePicturePageModule() {
    }
...
var ChangeProfilePicturePage = /** @class */ (function () {
    function ChangeProfilePicturePage(photo, router, profile, alert, toast, loading) {
        this.photo = photo;
        this.router = router;
    ...
    ChangeProfilePicturePage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ChangeProfilePicturePage.prototype.getFormData = function (event) {
        var _this = this;
    ...
    ChangeProfilePicturePage.prototype.uploadChangedPhoto = function () {
        var _this = this;
        var formElement = document.querySelectorAll('form');
        formElement.forEach(function (form) {
            if (form.id === 'changePhotoForm') {
                console.log('Got Form: ' + form);
                _this.formData = new FormData(form);
                _this.formData.append('oldPhotoKey', _this.awsPrefix);
                _this.formData.append('email', _this.userEmail);
            }
        });
        this.photo.changeProfilePicture(this.formData).subscribe(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var newPhoto;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(data);
                        newPhoto = data['objectUrl'];
                        return [4 /*yield*/, this.presentLoading()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.profile.profilePicture.next(newPhoto)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.presentToast()];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.router.navigate(['/home/profile'])];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ChangeProfilePicturePage.prototype.presentToast = function () {
    ...
    ChangeProfilePicturePage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    ChangeProfilePicturePage.prototype.back = function () {
        this.router.navigate(['/home/profile']);
    };
    ChangeProfilePicturePage.ctorParameters = function () { return [
