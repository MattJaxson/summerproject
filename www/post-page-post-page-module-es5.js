...
var EditCommentPageRoutingModule = /** @class */ (function () {
    function EditCommentPageRoutingModule() {
    }
...
var EditCommentPageModule = /** @class */ (function () {
    function EditCommentPageModule() {
    }
...
var EditCommentPage = /** @class */ (function () {
    ...
    EditCommentPage.prototype.ngOnInit = function () {
    ...
    EditCommentPage.prototype.cancel = function () {
        console.log('cancelling');
        this.modal.dismiss();
    };
    EditCommentPage.prototype.refreshComment = function () {
        this.postEmitterService.postPageRefresh();
    };
    EditCommentPage.prototype.edit = function (newComment) {
        var _this = this;
    ...
    EditCommentPage.prototype.editLoading = function (comment) {
    ...
    EditCommentPage.prototype.confirmAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
    ...
    EditCommentPage.ctorParameters = function () { return [
...
var ReplyCommentPageRoutingModule = /** @class */ (function () {
    function ReplyCommentPageRoutingModule() {
    }
...
var ReplyCommentPageModule = /** @class */ (function () {
    function ReplyCommentPageModule() {
    }
...
var ReplyCommentPage = /** @class */ (function () {
    ...
    ReplyCommentPage.prototype.ngOnInit = function () {
        // To collect comment data
    ...
    ReplyCommentPage.prototype.reply = function (reply) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, console.log('replying to comment...')];
                    case 1:
                        _a.sent();
                        // tslint:disable-next-line: max-line-length
                        return [4 /*yield*/, this.posts.replyComment(this.commentID, this.postID, reply.reply, this.userFullName, this.userEmail, this.userProfilePicture, this.commentUserFullName, this.commentUserEmail)
                    ...
                    case 2:
                        // tslint:disable-next-line: max-line-length
                        _a.sent();
                        return [4 /*yield*/, this.replyLoading()];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ReplyCommentPage.prototype.replyLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading, _a, role, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    ReplyCommentPage.prototype.confirmAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ReplyCommentPage.prototype.cancel = function () {
        console.log('cancelling reply...');
        this.modal.dismiss();
    };
    ReplyCommentPage.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavParams"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingController"] },
...
var ReportCommentPageRoutingModule = /** @class */ (function () {
    function ReportCommentPageRoutingModule() {
    }
...
var ReportCommentPageModule = /** @class */ (function () {
    function ReportCommentPageModule() {
    }
...
var ReportCommentPage = /** @class */ (function () {
    ...
    ReportCommentPage.prototype.ngOnInit = function () {
        // To collect comment data
    ...
    ReportCommentPage.prototype.report = function (reportReason) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, console.log('reporting comment...')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.reportLoading()];
                    case 2:
                        _a.sent();
                        // tslint:disable-next-line: max-line-length
                        return [4 /*yield*/, this.posts.reportComment(this.commentID, this.commentContents, this.post, this.postID, this.commentUserFullName, this.commentUserEmail, this.commentDate, this.userEmail, this.userFullName, reportReason.reportedReason)
                                .subscribe()];
                    case 3:
                        // tslint:disable-next-line: max-line-length
                        _a.sent();
    ...
    ReportCommentPage.prototype.reportLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading, _a, role, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    ReportCommentPage.prototype.confirmAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ReportCommentPage.prototype.cancel = function () {
        console.log('cancelling comment...');
        this.modal.dismiss();
    };
    ReportCommentPage.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavParams"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingController"] },
...
var PostPagePageRoutingModule = /** @class */ (function () {
    function PostPagePageRoutingModule() {
    }
...
var PostPagePage = /** @class */ (function () {
    ...
    PostPagePage.prototype.ngOnInit = function () {
        var _this = this;
        this.location.onPopState(function () {
            _this.postEmitterService.onBackAction();
        });
        ...
        this.posts.commentsSubject$.subscribe(function (commentsFromSub) {
            _this.comments = commentsFromSub;
        });
        this.posts.postsSubject$.subscribe(function (posts) {
            var currentPost;
            for (var _i = 0, posts_1 = posts; _i < posts_1.length; _i++) {
                var post = posts_1[_i];
                if (post._id == _this.postID) {
                    currentPost = post;
                }
            }
            _this.post = currentPost.post;
        });
    };
    PostPagePage.prototype.back = function () {
        this.postEmitterService.onBackAction();
        this.router.navigate(['/home/posts']);
    };
    PostPagePage.prototype.refreshAfterComment = function () {
        this.postEmitterService.postPageRefresh();
    };
    PostPagePage.prototype.refreshAfterDelete = function () {
        this.postEmitterService.postPageRefresh();
    };
    PostPagePage.prototype.refreshAfterFollow = function () {
        this.postEmitterService.postPageRefresh();
    };
    PostPagePage.prototype.follow = function (postID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, console.log('Following Post')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, console.log(postID)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.posts.followPost(postID, this.userEmail)];
                    case 3:
                        _a.sent();
                        this.following = true;
                        return [4 /*yield*/, this.followToast()];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PostPagePage.prototype.followToast = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var followToast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.refreshAfterDelete()];
                    case 2:
                        // await this.refreshAfterFollow();
                        _a.sent();
                        return [4 /*yield*/, followToast.present()];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PostPagePage.prototype.unFollow = function (postID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, console.log('Unfollowing Post')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, console.log(postID)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.posts.unFollowPost(postID, this.userEmail)];
                    case 3:
                        _a.sent();
                        this.following = false;
                        return [4 /*yield*/, this.unFollowToast()];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PostPagePage.prototype.unFollowToast = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var unFollowToast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        unFollowToast = _a.sent();
                        // await this.refreshAfterFollow();
                        return [4 /*yield*/, this.refreshAfterDelete()];
                    case 2:
                        // await this.refreshAfterFollow();
                        _a.sent();
                        return [4 /*yield*/, unFollowToast.present()];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PostPagePage.prototype.logScrolling = function (event) {
        // if (event.detail) {
    ...
    PostPagePage.prototype.onBlur = function () {
        var _this = this;
        this.textarea.getInputElement()
            .then(function (textarea) {
            _this.tabBar.style.height = '70px';
        });
    };
    // for when the user un focuses out of the comment textarea but hasnt submitted the comment
    PostPagePage.prototype.blur = function () {
        var _this = this;
        this.textarea.getInputElement()
            .then(function (textarea) {
            textarea.blur();
    ...
    PostPagePage.prototype.comment = function (postID, userFullName, userEmail, userProfilePicture, comment) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                console.log(comment);
    ...
    PostPagePage.prototype.commentLoading = function (postID, userFullName, userEmail, userProfilePicture, comment) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading, _a, role, data;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.posts.comment(postID, userFullName, userEmail, userProfilePicture, comment).subscribe(function (data) {
                            _this.posts.getPostInfo(_this.postID).subscribe(function (post) {
                                for (var _i = 0, _a = post['comments']; _i < _a.length; _i++) {
                                    var postComments = _a[_i];
                    ...
                    case 2:
                        loading = _b.sent();
                        return [4 /*yield*/, this.refreshAfterComment()];
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, loading.present()];
                    case 4:
    ...
    PostPagePage.prototype.report = function (commentID, commentCotents, post, postID, commentUserFullName, commentUserEmail, commentDate) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // Get information from comment
                    return [4 /*yield*/, console.log('Attemping to report comment')];
                    case 1:
                        // Get information from comment
                        _a.sent();
                        // tslint:disable-next-line: max-line-length
                        return [4 /*yield*/, this.reportModal(commentID, commentCotents, post, postID, commentUserFullName, commentUserEmail, commentDate, this.userEmail, this.userFullName)];
                    case 2:
                        // tslint:disable-next-line: max-line-length
                        _a.sent();
                        return [2 /*return*/];
    ...
    PostPagePage.prototype.reportModal = function (commentID, commentCotents, post, postID, commentUserFullName, commentUserEmail, commentDate, userEmail, userFullName) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        reportModalConfig = _a.sent();
                        return [4 /*yield*/, reportModalConfig.present()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PostPagePage.prototype.reply = function (commentID, userFullName, userEmail, userProfilePicture, commentUserFullName, commentUserEmail) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, console.log('Attemping to reply to comment')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.replyModal(commentID, this.postID, userFullName, userEmail, userProfilePicture, commentUserFullName, commentUserEmail)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PostPagePage.prototype.replyModal = function (commentID, postID, userFullName, userEmail, userProfilePicture, commentUserFullName, commentUserEmail) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        replyModalConfig = _a.sent();
                        return [4 /*yield*/, replyModalConfig.present()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    // tslint:disable-next-line: max-line-length
    PostPagePage.prototype.repliesModal = function (postID, replies, comment, commentID, commentUserFullName, commentUserEmail, commentDate, userProfilePicture, userFullName, userEmail) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        repliesPageModalConfig = _a.sent();
                        return [4 /*yield*/, repliesPageModalConfig.present()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PostPagePage.prototype.editComment = function (commentID, commentCotents, postID, userEmail) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, console.log(commentID)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, console.log('Attemping to edit comment')];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.editCommentModal(commentID, commentCotents, postID, userEmail)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PostPagePage.prototype.editCommentModal = function (commentID, commentCotents, postID, userEmail) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var editAlertConfig;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        editAlertConfig = _a.sent();
                        return [4 /*yield*/, editAlertConfig.present()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PostPagePage.prototype.editPost = function (postID, post) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, console.log('Attemping to edit comment')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.editPostModal(postID, post)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PostPagePage.prototype.editPostModal = function (postID, post) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        editPostModalConfig = _a.sent();
                        return [4 /*yield*/, editPostModalConfig.present()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    PostPagePage.prototype.deleteComment = function (commentID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    PostPagePage.prototype.deleteCommentAlert = function (postID, commentID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    text: 'Delete',
                                    handler: function () {
                                        _this.deleteCommentLoading(_this.postID, commentID)
                                            .catch(function (err) {
                                            console.log(err);
                                        });
                                    }
    ...
    PostPagePage.prototype.deleteCommentLoading = function (postID, commentID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading, _a, role, data;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.posts.deleteComment(this.postID, commentID).subscribe(function (values) {
                            ...
                            for (var _i = 0, comments_1 = comments; _i < comments_1.length; _i++) {
                                ...
                                // If this comment is the logged in user, they can delete and edit
                                if (comment.userEmail === _this.userEmail) {
                                    console.log('true');
                                    comment.isUser = true;
                                    comment.canDeleteComment = true;
                                    comment.canReport = false;
    ...
    PostPagePage.prototype.deletePost = function (postID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    PostPagePage.prototype.deletePostAlert = function (postID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, this.deletePostLoading(postID)];
                                                case 1:
                                                    _a.sent();
                                                    return [2 /*return*/];
                                            }
    ...
    PostPagePage.prototype.deletePostLoading = function (postID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading, _a, role, data;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        console.log(postID);
                        return [4 /*yield*/, this.posts.deletePost(postID).subscribe(function (remainingPosts) {
                                _this.posts.postsSubject$.next(Object.values(remainingPosts).reverse());
                                console.log(_this.posts.postsSubject$.getValue());
                            })];
                    case 1:
                        _b.sent();
                        this.postEmitterService.onBackAction();
                        return [4 /*yield*/, this.router.navigate(['/home/posts'])];
                    case 2:
                        _b.sent();
                        console.log('Loading dismissed!');
                        return [4 /*yield*/, this.loading.create({
    ...
    PostPagePage.prototype.getPostInfo = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.profile.getUserDetails().subscribe(function (details) {
                            var userEmail = details['email'];
                            _this.userEmail = userEmail;
                            var userFullName = details['fullName'];
                            var userProfilePicture = details['profilePicture'];
                            ...
                            _this.posts.getPostInfo(_this.postID).subscribe(function (postInfo) {
                                ...
                                if (creatorEmail === _this.userEmail) {
                                    _this.isUser = true;
                                }
                                ...
                                _this.creatorEmail = creatorEmail;
                                _this.creatorProfilePicture = creatorProfilePicture;
                                _this.date = date;
                                _this.followers = followers;
                                _this.comments = comments.reverse();
                                _this.following = following;
                                _this.post = post;
                                _this.userProfilePicture = userProfilePicture;
    ...
    PostPagePage.prototype.doRefresh = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    PostPagePage.ctorParameters = function () { return [
