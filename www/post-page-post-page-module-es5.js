(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["post-page-post-page-module"], {
  ...
  function srcAppModalsEditCommentEditCommentPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let EditCommentPage = class EditCommentPage {
      ...
      ngOnInit() {
        ...
        this.commentContents = this.navParams.get('commentCotents'); // To collect comment data
    ...
    let ReplyCommentPage = class ReplyCommentPage {
      ...
      replyLoading() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          yield this.modal.dismiss(); // await this.confirmAlert();
    ...
    let ReportCommentPage = class ReportCommentPage {
      ...
      report(reportReason) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          yield this.posts.reportComment(this.commentID, this.commentContents, this.post, this.postID, this.commentUserFullName, this.commentUserEmail, this.commentDate, this.userEmail, this.userFullName, reportReason.reportedReason).subscribe();
        });
      }
  ...
  function srcAppPagesPostsPostPagePostPageModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_modals_replies_page_replies_page_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
  ...
  function srcAppPagesPostsPostPagePostPagePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_emitters_post_page_emitter_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! src/app/emitters/post-page-emitter.service */
    "./src/app/emitters/post-page-emitter.service.ts");
    /* harmony import */


    var src_app_modals_replies_page_replies_page_page__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! src/app/modals/replies-page/replies-page.page */
    "./src/app/modals/replies-page/replies-page.page.ts"); // tslint:disable-next-line: max-line-length
