...
var routes = [
    ...
    {
        path: 'confirm',
        loadChildren: function () { return __webpack_require__.e(/*! import() | confirm-confirm-module */ "confirm-confirm-module").then(__webpack_require__.bind(null, /*! ../confirm/confirm.module */ "./src/app/pages/profile/change-phone/confirm/confirm.module.ts")).then(function (m) { return m.ConfirmPageModule; }); }
    }
];
var ChangePhonePageRoutingModule = /** @class */ (function () {
    function ChangePhonePageRoutingModule() {
    }
...
var ChangePhonePageModule = /** @class */ (function () {
    function ChangePhonePageModule() {
    }
...
var ChangePhonePage = /** @class */ (function () {
    function ChangePhonePage(formBuilder, router, auth, alertController, profile) {
    ...
    ChangePhonePage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ChangePhonePage.prototype.back = function () {
        console.log('change phone number cancelled');
        this.router.navigate(['/home/profile/edit-profile-page']);
    };
    ChangePhonePage.prototype.presentAlert = function () {
    ...
    ChangePhonePage.prototype.confirmChangedPhoneNumber = function (newNumber, password) {
    ...
    ChangePhonePage.ctorParameters = function () { return [
