...
/***/ "./node_modules/raw-loader/index.js!./src/app/modals/replies-page/replies-page.page.html":
/*!**************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/modals/replies-page/replies-page.page.html ***!
  \**************************************************************************************/
...
var RepliesPagePageRoutingModule = /** @class */ (function () {
    function RepliesPagePageRoutingModule() {
    }
...
var RepliesPagePageModule = /** @class */ (function () {
    function RepliesPagePageModule() {
    }
...
var RepliesPagePage = /** @class */ (function () {
    function RepliesPagePage(formBuilder, modal, navParams, loading, profile, posts, alert, postEmitterService) {
    ...
    RepliesPagePage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.replies$.subscribe(function (data) {
            _this.replies = data;
            for (var _i = 0, _a = _this.replies; _i < _a.length; _i++) {
                var reply = _a[_i];
    ...
    RepliesPagePage.prototype.cancel = function () {
        console.log('cancelling comment...');
        this.modal.dismiss();
    };
    RepliesPagePage.prototype.refreshRepliesAmount = function () {
        this.postEmitterService.postPageRefresh();
    };
    RepliesPagePage.prototype.reply = function (reply) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // Reset Comment Input
                    return [4 /*yield*/, this.repliesForm.reset()];
                    case 1:
                        // Reset Comment Input
                        _a.sent();
                        return [4 /*yield*/, console.log('replying to comment...')];
                    case 2:
                        _a.sent();
                        ...
                        return [4 /*yield*/, this.posts.replyComment(this.commentID, this.postID, reply.reply, this.userFullName, this.userEmail, this.userProfilePicture, this.commentUserFullName, this.commentUserEmail)
                                ...
                                _this.replies = currentCommentReplies;
                                _this.posts.commentsSubject$.next(comments.reverse());
                                _this.replies$.next(_this.replies.reverse());
                            })];
                    case 3:
                        // tslint:disable-next-line: max-line-length
                        _a.sent();
                        return [4 /*yield*/, this.repliesLoading()];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RepliesPagePage.prototype.deleteReply = function (replyID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.posts.deleteReply(replyID, this.commentID, this.postID).subscribe(function (data) {
                                console.log(data);
                                var currentComment;
                                var currentCommentReplies = [];
                                var comments = data['comments'];
                                ...
                                for (var _a = 0, comments_3 = comments; _a < comments_3.length; _a++) {
                                    var comment = comments_3[_a];
                                    comment.repliesLength = comment.replies.length;
                                    comment.isUser = false;
                                    comment.canDeleteComment = false;
                                    comment.canReport = true;
    ...
    RepliesPagePage.prototype.repliesLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        loading = _b.sent();
                        return [4 /*yield*/, this.refreshRepliesAmount()];
                    case 2:
                        _b.sent();
    ...
    RepliesPagePage.prototype.confirmAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    RepliesPagePage.prototype.ScrollToTop = function () {
    ...
    RepliesPagePage.prototype.ScrollToReply = function () {
    ...
    RepliesPagePage.ctorParameters = function () { return [
    ...
    RepliesPagePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./replies-page.page.html */ "./node_modules/raw-loader/index.js!./src/app/modals/replies-page/replies-page.page.html"),
            styles: [__webpack_require__(/*! ./replies-page.page.scss */ "./src/app/modals/replies-page/replies-page.page.scss")]
        }),
