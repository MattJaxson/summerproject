...
var routes = [
    ...
    {
        path: 'confirm',
        loadChildren: function () { return __webpack_require__.e(/*! import() | confirm-confirm-module */ "confirm-confirm-module").then(__webpack_require__.bind(null, /*! ./confirm/confirm.module */ "./src/app/pages/profile/change-address/confirm/confirm.module.ts")).then(function (m) { return m.ConfirmPageModule; }); }
    }
];
var ChangeAddressPageRoutingModule = /** @class */ (function () {
    function ChangeAddressPageRoutingModule() {
    }
...
var ChangeAddressPageModule = /** @class */ (function () {
    function ChangeAddressPageModule() {
    }
...
var ChangeAddressPage = /** @class */ (function () {
    function ChangeAddressPage(formBuilder, profile, auth, router) {
    ...
    ChangeAddressPage.prototype.ngOnInit = function () {
    ...
    ChangeAddressPage.prototype.back = function () {
        this.router.navigate(['/home/profile/edit-profile-page']);
    };
    ChangeAddressPage.prototype.confirmChangeAddress = function (email, addressOne, addressTwo, city, state, zip, password) {
    ...
    ChangeAddressPage.ctorParameters = function () { return [
