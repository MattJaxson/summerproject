...
var FavoritesPage = /** @class */ (function () {
    ...
    FavoritesPage.prototype.getFavoriteJobs = function () {
        var _this = this;
        ...
        this.profile.getUserDetails().subscribe(function (data) {
            ...
            _this.favorites.favoriteJobs$.subscribe(function (favs) {
                ...
                _this.favorites.getFavorites(_this.userEmail).subscribe(function (favDetails) {
                    _this.favoriteJobsObj = favDetails;
                    console.log('Favorite jobs:');
                    console.log(favDetails);
                    for (var _i = 0, _a = _this.favoriteJobsObj; _i < _a.length; _i++) {
                        var job = _a[_i];
    ...
    FavoritesPage.prototype.jobPage = function (job) {
        console.log(job);
    ...
    FavoritesPage.prototype.favoriteJobPage = function () {
