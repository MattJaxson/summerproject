...
var PhotoService = /** @class */ (function () {
    ...
    // Testing
    PhotoService.prototype.imageUpload = function (imageForm) {
        console.log('image uploading');
        console.log(imageForm);
        return this.http.post(this.BACKEND_URL + "/api/photo/upload-profile-picture", imageForm);
    };
    PhotoService.prototype.changeProfilePicture = function (imageForm) {
        console.log(imageForm);
...
var ResumeService = /** @class */ (function () {
    ...
    ResumeService.prototype.resumeUpload = function (resumeForm) {
        console.log('resume uploading');
        return this.http.post(this.BACKEND_URL + "/api/resume/upload-resume", resumeForm);
    };
    ResumeService.prototype.changeResume = function (imageForm) {
        console.log(imageForm);
