...
var routes = [
    ...
    },
    {
        ...
        loadChildren: function () { return __webpack_require__.e(/*! import() | mentor-page-mentor-page-module */ "mentor-page-mentor-page-module").then(__webpack_require__.bind(null, /*! ./mentor-page/mentor-page.module */ "./src/app/pages/mentors/mentor-page/mentor-page.module.ts")).then(function (m) { return m.MentorPagePageModule; }); }
    }
];
var MentorsPageRoutingModule = /** @class */ (function () {
    function MentorsPageRoutingModule() {
    }
...
var MentorsPage = /** @class */ (function () {
    ...
    MentorsPage.prototype.ngOnInit = function () {
        var _this = this;
        this.mentors.getMentors().subscribe(function (mentors) {
            _this.allMentors = mentors;
        });
    };
    MentorsPage.prototype.mentorPage = function (mentor) {
    ...
    MentorsPage.ctorParameters = function () { return [
...
var MentorsService = /** @class */ (function () {
    ...
    MentorsService.prototype.sendMentorAnEmail = function (message, mentorName, mentorEmail, studentEmail, studentName, studentCity, studentState, studentAge, studentGrade, studentSchool, studentProfilePic, studentResume) {
