...
let AddPostPage = class AddPostPage {
    ...
    post(creatorName, creatorEmail, creatorProfilePicture, post) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.presentLoading();
            yield this.posts.addPost(creatorName, creatorEmail, creatorProfilePicture, post).subscribe(data => {
                console.log(data);
            });
