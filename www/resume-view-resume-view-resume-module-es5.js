...
var ViewResumePageRoutingModule = /** @class */ (function () {
    function ViewResumePageRoutingModule() {
    }
...
var ViewResumePageModule = /** @class */ (function () {
    function ViewResumePageModule() {
    }
...
var ViewResumePage = /** @class */ (function () {
    function ViewResumePage(router, profile, domSanitizer) {
        this.router = router;
        this.profile = profile;
        this.domSanitizer = domSanitizer;
    }
    ViewResumePage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ViewResumePage.prototype.sanitizeImageUrl = function (imageUrl) {
        return this.domSanitizer.bypassSecurityTrustResourceUrl(imageUrl);
    };
    ViewResumePage.prototype.back = function () {
        this.router.navigate(['/home/profile']);
    };
    ViewResumePage.prototype.updateResume = function () {
        console.log('Updating Resume from View Resume page');
        this.router.navigate(['/home/profile/update-resume']);
    };
    ViewResumePage.ctorParameters = function () { return [
