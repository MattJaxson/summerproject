...
var routes = [
    ...
    {
        path: 'confirm',
        loadChildren: function () { return __webpack_require__.e(/*! import() | confirm-confirm-module */ "confirm-confirm-module").then(__webpack_require__.bind(null, /*! ../confirm/confirm.module */ "./src/app/pages/profile/change-password/confirm/confirm.module.ts")).then(function (m) { return m.ConfirmPageModule; }); }
    },
];
...
var ChangePasswordPage = /** @class */ (function () {
    ...
    ChangePasswordPage.prototype.formOnChanges = function () {
        var _this = this;
        ...
        this.changePassword.valueChanges
            ...
            if (_this.changePassword.controls.newPassword.value === _this.changePassword.controls.reTypeNewPassword.value &&
                _this.changePassword.controls.newPassword.touched) {
    ...
    ChangePasswordPage.prototype.presentAlert = function () {
    ...
    ChangePasswordPage.prototype.confirmChangedPassword = function (oldPassword, newPassword, reTypeNewPassword) {
