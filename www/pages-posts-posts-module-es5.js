(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-posts-posts-module"], {
  ...
  function srcAppPagesPostsPostRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    const routes = [{
      ...
      "post-page-post-page-module").then(__webpack_require__.bind(null,
  ...
  function srcAppPagesPostsPostsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_follow_icon_follow_icon_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../../components/follow-icon/follow-icon.component */
    "./src/app/components/follow-icon/follow-icon.component.ts");
    ...
    PostPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
      imports: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _post_routing_module__WEBPACK_IMPORTED_MODULE_7__["PostRoutingModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild([{
        path: '',
        component: _posts_page__WEBPACK_IMPORTED_MODULE_6__["PostsPage"]
      }])],
      declarations: [_posts_page__WEBPACK_IMPORTED_MODULE_6__["PostsPage"], _components_follow_icon_follow_icon_component__WEBPACK_IMPORTED_MODULE_8__["FollowIconComponent"]]
    })], PostPageModule);
    /***/
  },
    ...
    let PostsPage = class PostsPage {
      ...
      ngOnInit() {
        ...
        this.posts.getPosts().subscribe(posts => {
          ...
          date = Object(date_fns__WEBPACK_IMPORTED_MODULE_6__["formatDistance"])(new Date(), new Date(date), {
            includeSeconds: true
          });
          this.date = date;
