  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-posts-posts-module"], {
    ...
    function FvZU(module, __webpack_exports__, __webpack_require__) {
      ...
      var PostsPage = /*#__PURE__*/function () {
        function PostsPage(router, modal, posts, profile, toast, loading, formBuilder, postsEmitterService, studentChat, notificationsService) {
        ...
        _createClass(PostsPage, [{
          ...
          value: function searchHashtags() {
            ...
            var searchedPosts = [];
            var searchTermArray = this.searchTerm.split(','); // console.log('Searching...\n');
            ...
            searchTermArray.forEach(function (searchedTag) {
              ...
              _this2.loadedAllPosts.filter(function (foundPost) {
          ...
          value: function getUserInfo() {
            ...
            this.postsSub = this.profile.getUserDetails().subscribe(function (details) {
              ...
              _this5.notificationsSub = _this5.notificationsService.notifications$.subscribe(function (notifications) {
                console.log(notifications);
                _this5.notificationsLength = notifications.length;
              });
            });
          }
        }, {
          ...
          value: function getFollowingPosts() {
            ...
            this.profileSub = this.profile.getUserDetails().subscribe(function (details) {
              ...
              _this6.studentChat.conversations$.next(Object.values(details['studentChat']).reverse());
            });
          }
        }, {
          key: "doRefresh",
          value: function doRefresh(event) {
            ...
            this.postsSub = this.posts.getPosts().subscribe(function (jobs) {
              _this7.allPosts = Object.values(jobs).reverse();
                  ...
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      this.postsSub = this.posts.getPosts().subscribe(function (posts) {
                        ...
                        _this8.allPostsLength = _this8.allPosts.length;

                        _this8.allPosts.reverse(); // Second Array of Events


                        _this8.loadedAllPosts = Object.values(posts);

                        _this8.loadedAllPosts.reverse();

                        _this8.posts.postsSubject$.next(_this8.allPosts);

                        var _iterator2 = _createForOfIteratorHelper(_this8.allPosts),
                            _step2;
                        ...
                        if (_this8.allPosts.length === 0) {
                          console.log('That search had no results!');
                          return _this8.noPosts = true;
                        }

                        if (_this8.allPosts.length > 0) {
                          console.log('That search had results!');
                          return _this8.noPosts = false;
                        }
                      });
                    ...
                    case 0:
                      ...
                      return this.posts.comment(postID, userFullName, userEmail, userProfilePicture, _comment.comment).subscribe(function (newComment) {
                        _this9.postsSub = _this9.posts.getPostInfo(postID).subscribe(function (post) {
                          ...
                          _this9.notificationsService.commentNotification(_this9.userEmail, postCreator, postID, newComment).subscribe();
                        });
                      });
      ...
      PostsPage.propDecorators = {
        ...
        searchbar: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"],
          args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonSearchbar"], {
            "static": false
          }]
        }]
      };
