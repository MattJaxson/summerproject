...
var GoingPageRoutingModule = /** @class */ (function () {
    function GoingPageRoutingModule() {
    }
...
var GoingPageModule = /** @class */ (function () {
    function GoingPageModule() {
    }
...
var GoingPage = /** @class */ (function () {
    ...
    GoingPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    GoingPage.prototype.eventPage = function (event) {
        // tslint:disable-next-line: max-line-length
        this.router.navigate(['/home/events/events-page', event._id, event.title, event.addressOne, event.addressOne, event.city, event.state, event.zip, event.dateCreated, event.date, event.time, event.photo, event.description]);
    };
    GoingPage.prototype.goBack = function () {
        this.eventEmitterService.onBackAction();
        this.router.navigate(['/home/events']);
    };
    GoingPage.prototype.cancel = function (eventID) {
        var _this = this;
        console.log(eventID);
        ...
        this.events.notGoingToEvent(eventID, this.userEmail, this.id).subscribe(function () {
            _this.refreshGoingEvents();
            _this.presentNotGoingToast();
        });
    };
    GoingPage.prototype.refreshGoingEvents = function () {
        var _this = this;
        this.events.getEventsGoing(this.id).subscribe(function (eventsGoing) {
            _this.goingToEvents = Object.values(eventsGoing);
            _this.goingToEvents.reverse();
            console.log("Updated events going list: " + _this.goingToEvents);
            for (var _i = 0, _a = _this.goingToEvents; _i < _a.length; _i++) {
                var event_1 = _a[_i];
                ...
                event_1.dateCreated = Object(date_fns__WEBPACK_IMPORTED_MODULE_5__["formatDistanceToNow"])(new Date(event_1.dateCreated), {
                    includeSeconds: true,
                    addSuffix: true
                });
            }
            _this.goingToEvents$.next(_this.goingToEvents);
            _this.cdr.detectChanges(); // Check for new changes in events going list
        });
    };
    GoingPage.prototype.presentNotGoingToast = function () {
    ...
    GoingPage.prototype.presentAlertMultipleButtons = function (eventID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    GoingPage.ctorParameters = function () { return [
