...
let PostsPage = class PostsPage {
    constructor(router, posts, profile, toast, formBuilder, postsEmitterService) {
        this.router = router;
        this.posts = posts;
    ...
    comment(comment, postID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.posts.comment(postID, date, this.userFullName, this.userEmail, this.profilePicture).subscribe();
