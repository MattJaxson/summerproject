...
var routes = [
    ...
    },
    {
        ...
        loadChildren: function () { return __webpack_require__.e(/*! import() | job-page-job-page-module */ "job-page-job-page-module").then(__webpack_require__.bind(null, /*! ./job-page/job-page.module */ "./src/app/pages/jobs/job-page/job-page.module.ts")).then(function (m) { return m.JobPagePageModule; }); }
    },
    {
        path: 'favorites',
        loadChildren: function () { return __webpack_require__.e(/*! import() | favorites-favorites-module */ "favorites-favorites-module").then(__webpack_require__.bind(null, /*! ./favorites/favorites.module */ "./src/app/pages/jobs/favorites/favorites.module.ts")).then(function (m) { return m.FavoritesPageModule; }); }
    }
];
var JobsPageRoutingModule = /** @class */ (function () {
    function JobsPageRoutingModule() {
    }
...
var JobsPage = /** @class */ (function () {
    ...
    JobsPage.prototype.ngOnInit = function () {
        ...
        this.jobs.getJobs().subscribe(function (jobs) {
            ...
            console.log("alljobs: ", _this.allJobs);
        });
    ...
    //   );
    // }
    JobsPage.prototype.jobPage = function (job) {
    ...
    JobsPage.prototype.favoritesPage = function () {
        this.router.navigate(['/home/jobs/favorites']);
    };
    JobsPage.prototype.doRefresh = function (job) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.allJobs = [];
                        this.getFavoriteJobs();
                        return [4 /*yield*/, this.jobs.getJobs().subscribe(function (jobs) {
                                _this.allJobs = Object.values(jobs);
                                _this.allJobsLength = _this.allJobs.length;
                                _this.allJobs.reverse();
                                ...
                                for (var _i = 0, _a = _this.allJobs; _i < _a.length; _i++) {
                                    var job_1 = _a[_i];
                                    job_1.dateCreated = Object(date_fns__WEBPACK_IMPORTED_MODULE_7__["formatDistanceToNow"])(new Date(job_1.dateCreated), { addSuffix: false });
                                }
                            })];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, console.log('Refreshing jobs Page..')];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    JobsPage.prototype.getJobs = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.jobs.getJobs().subscribe(function (jobs) {
                            _this.allJobs = Object.values(jobs);
                            _this.allJobsLength = _this.allJobs.length;
                            _this.allJobs.reverse();
                            _this.searching = false;
    ...
    JobsPage.prototype.filter = function ($job) {
        var _this = this;
    ...
    JobsPage.prototype.initializeItems = function () {
        this.allJobs = this.loadedAllJobs;
    };
    JobsPage.prototype.presentLoadingWithOptions = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
...
var JobsService = /** @class */ (function () {
    ...
    JobsService.prototype.sendEmailApplication = function (user, age, phoneNumber, reason, jobTitle, jobCompanyEmail) {
        console.log("Sending email to " + jobCompanyEmail);
        return this.http.post(this.BACKEND_URL + "/api/jobs/send-application", { user: user, age: age, phoneNumber: phoneNumber, reason: reason, jobTitle: jobTitle, jobCompanyEmail: jobCompanyEmail });
    };
