      ...
      _createClass(JobsPage, [{
        ...
        value: function getFavoriteJobs() {
          ...
          this.profile.getUserDetails().subscribe(function (data) {
            _this2.favoriteJobs = data['favoriteJobs'];
            console.log('Favorite Jobs:');
            console.log(_this2.favoriteJobs);

            _this2.favorites.favoriteJobs$.next(_this2.favoriteJobs);

            _this2.favorites.favoriteJobs$.subscribe(function (favs) {
              console.log("Favorite Jobs in Service: ".concat(favs));
              _this2.favoriteJobsAmount = favs.length;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    this.getFavoriteJobs();
                    _context.next = 4;
                    return this.jobs.getJobs().subscribe(function (jobs) {
                      _this3.allJobs = Object.values(jobs);
                      _this3.allJobsLength = _this3.allJobs.length;

                      _this3.allJobs.reverse();

                      _this3.searching = false; // Format Times

                      var _iterator2 = _createForOfIteratorHelper(_this3.allJobs),
                          _step2;
                ...
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return this.jobs.getJobs().subscribe(function (jobs) {
                      ...
                      var _iterator3 = _createForOfIteratorHelper(_this4.allJobs),
                          _step3;
          ...
          this.allJobs = this.allJobs.filter(function (currentJobs) {
            ...
            if (currentJobs.title && searchTerm) {
              if (currentJobs.title.toLowerCase().indexOf(searchTerm.toLowerCase()) > -1) {
                ...
                console.log(currentJobs);
                _this5.searchTerm = searchTerm;
                _this5.searching = true;
                _this5.noSearchInput = false;
                return true;
              }
