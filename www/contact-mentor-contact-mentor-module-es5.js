...
var routes = [
    ...
    },
    {
        ...
        loadChildren: function () { return __webpack_require__.e(/*! import() | confirm-confirm-module */ "confirm-confirm-module").then(__webpack_require__.bind(null, /*! ./confirm/confirm.module */ "./src/app/pages/mentors/mentor-page/contact-mentor/confirm/confirm.module.ts")).then(function (m) { return m.ConfirmPageModule; }); }
    }
];
var ContactMentorPageRoutingModule = /** @class */ (function () {
    function ContactMentorPageRoutingModule() {
    }
...
var ContactMentorPageModule = /** @class */ (function () {
    function ContactMentorPageModule() {
    }
...
var ContactMentorPage = /** @class */ (function () {
    function ContactMentorPage(profile, mentors, activatedRoute, formBuilder, router) {
    ...
    ContactMentorPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.contactMenorForm.get("message").valueChanges.subscribe(function (msg) {
            ...
            setTimeout(function () {
                ...
                console.log("Valid: " + _this.contactMenorForm.valid);
            }, 100);
        });
    ...
    ContactMentorPage.prototype.confirm = function (value) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendMessage(value)];
                    case 1:
                        _a.sent();
                        // tslint:disable-next-line: max-line-length
                        return [4 /*yield*/, this.router.navigate(['/home/mentors/mentor-page/:name/:title/:email/:description/:photo/:city/:state/contact-mentor/:name/:email/:photo/confirm', this.mentorName, this.mentorEmail, this.mentorPhoto])];
                    case 2:
                        // tslint:disable-next-line: max-line-length
                        _a.sent();
                        return [2 /*return*/];
    ...
    ContactMentorPage.prototype.userDetails = function () {
        var _this = this;
        this.profile.getUserDetails().subscribe(function (details) {
            _this.userEmail = details['email'];
            _this.userName = details['fullName'];
            _this.userCity = details['city'];
            _this.userState = details['state'];
            _this.userAge = details['age'];
            _this.userGrade = details['grade'];
            _this.userSchool = details['school'];
            _this.userProfilePicture = details['profilePicture'];
            _this.userResume = details['resume'];
        });
    };
    ContactMentorPage.prototype.sendMessage = function (value) {
    ...
    ContactMentorPage.ctorParameters = function () { return [
