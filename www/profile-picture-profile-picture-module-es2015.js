...
const routes = [
    ...
    {
        path: 'upload-resume',
        loadChildren: () => Promise.all(/*! import() | upload-resume-upload-resume-module */[__webpack_require__.e("common"), __webpack_require__.e("upload-resume-upload-resume-module")]).then(__webpack_require__.bind(null, /*! ../upload-resume/upload-resume.module */ "./src/app/pages/auth/sign-up/upload-resume/upload-resume.module.ts")).then(m => m.UploadResumePageModule)
    },
];
...
let ProfilePicturePage = class ProfilePicturePage {
    constructor(router, alertController, photo, auth, toast) {
        this.router = router;
    ...
    uploadPhoto() {
        ...
        if (this.uploadedPhoto === true) {
            this.photo.imageUpload(this.formData).subscribe(data => {
                console.log(data);
                            ...
                            canvasElement.forEach(canvas => {
                                if (canvas.id === 'default-picture-wrapper') {
                                    ...
                                    canvas.toBlob((blob) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                                        ...
                                        yield this.photo.imageUpload(canvasData).subscribe(data => {
                                            console.log(data);
