...
var UpdateResumePageRoutingModule = /** @class */ (function () {
    function UpdateResumePageRoutingModule() {
    }
...
var UpdateResumePageModule = /** @class */ (function () {
    function UpdateResumePageModule() {
    }
...
var UpdateResumePage = /** @class */ (function () {
    ...
    UpdateResumePage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    UpdateResumePage.prototype.back = function () {
        this.router.navigate(['/home/profile/view-resume']);
    };
    UpdateResumePage.prototype.getFormData = function (event) {
        var _this = this;
    ...
    UpdateResumePage.prototype.uploadResume = function () {
        var _this = this;
        var formElement = document.querySelectorAll('form');
        formElement.forEach(function (form) {
            if (form.id === 'changeResumeForm') {
                console.log('Got Form: ' + form);
                _this.formData = new FormData(form);
                _this.formData.append('oldResumeKey', _this.awsPrefix);
                _this.formData.append('email', _this.userEmail);
            }
        });
        this.resume.changeResume(this.formData).subscribe(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var newResume;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.profile.resume.next(newResume)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.presentToast()];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.router.navigate(['/home/profile/view-resume'])];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UpdateResumePage.prototype.presentToast = function () {
    ...
    UpdateResumePage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    UpdateResumePage.ctorParameters = function () { return [
